...
class MainActivity : Activity() {
    ...
    private fun statusButton(): View {
        val d = driver
        val restricted = isOperationallyRestricted()
    ...
    private fun isOperationallyRestricted(): Boolean = batteryPercent() <= 10 || !hasLocationPermission() || !isGpsOn() || !hasNotificationPermission()
