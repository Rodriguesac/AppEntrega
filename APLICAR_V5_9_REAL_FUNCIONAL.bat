...
echo.
echo ==========================================================
echo  UP ENTREGAS / RODRIGUES ENTREGADOR - V5.9 REAL FUNCIONAL
echo ==========================================================
echo.
echo Este aplicador copia app, Gradle e workflow para o repositorio.
echo Ele preserva o app\google-services.json atual se ja existir.
echo.
...
set SRC=%~dp0
set KEEP=%TEMP%\google-services-v59-!TS!.json
...
if exist "%DEST%\app" (
  ...
  robocopy "%DEST%\app" "%DEST%\_backup_app_antes_v59_real_!TS!" /E >nul
)

echo Aplicando app real funcional...
...
echo Limpando arquivos antigos desnecessarios do topo do repositorio...
...
echo   git status
echo   git add .
echo   git commit -m "Aplicar V5.9 real funcional"
echo   git push
echo.
pause
